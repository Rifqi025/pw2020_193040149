...
<table border="1" cellpadding="13" cellspacing="0">
  ...
  <?php foreach ($alat_musik as $musik) : ?>
    <tr>
      <td><?= $i; ?></td>
      <td>
        <a href="ubah.php?id=<?= $musik['kode_barang']; ?>"><button>Ubah</button></a>
        <a href="hapus.php?id=<?= $musik['kode_barang']; ?>" onclick="return confirm('Hapus Data ?')"><button>Hapus</button></a>
      </td>
