...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Apr 2020 pada 15.06
...
CREATE TABLE `alat_musik` (
  ...
  `harga_barang` char(15) COLLATE utf8mb4_swedish_ci NOT NULL
...
(1, 'gitar.jpg', 'Epiphore', 'Semi-Akustik', 'Kayu Maple', 'Rp.7.000.000'),
(2, 'bass.jpg', 'Fender', 'Bass Electic', 'Kayu Alder', 'Rp.12.000.000'),
(3, 'drum.jpg', 'Tama', 'Rockstar', 'Plywood', 'Rp.8.500.000'),
(4, 'piano.jpg', 'Roland', 'Piano Digital/Electric', 'Kayu Cemara Sitka', 'Rp.8.000.000'),
...
(10, 'clarinet.jpg', 'Moresky', 'Suprano A', 'Logam', 'Rp.6.000.000');
